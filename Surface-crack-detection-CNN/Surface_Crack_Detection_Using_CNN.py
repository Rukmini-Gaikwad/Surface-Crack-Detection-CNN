# =========================================================
# Project Name : Industrial Surface Crack Detection
#                using Convolutional Neural Networks (CNN)
#
# Author       : Rukmini Jayhind Gaikwad
# Date         : 30/06/2026
#
# Description  : This project builds and trains a CNN-based
#                image classification model to detect surface
#                cracks in industrial materials.
# =========================================================
import os
import shutil
import random
...
# Description   : Verifies whether a given dataset folder
#                 exists on disk; exits the program if not.
# Input         : folder_path (str) - path of folder to check
# Output        : None (terminates program on failure)
# =========================================================
...
# Description   : Lists all valid image files present inside
#                 a given folder based on allowed extensions.
# Input         : folder (str) - path of folder to scan
# Output        : List of image file names (list of str)
# =========================================================
...
# Description   : Splits a class's images into train,
#                 validation, and test sets (70/15/15) and
#                 copies them into the processed dataset
#                 directory structure.
# Input         : source_folder (str) - original folder path
#                 image_files (list)  - list of image filenames
#                 class_name (str)    - target class label
#                 ("Crack" or "NoCrack")
# Output        : None (copies files to disk, prints summary)
# =========================================================
...
# Description   : Loads a single image, preprocesses it, and
#                 uses the trained model to predict whether
#                 the image shows a crack or no crack. Displays
#                 the result visually.
# Input         : image_path (str) - path of the image to test
# Output        : None (prints prediction, shows result plot)
# =========================================================
